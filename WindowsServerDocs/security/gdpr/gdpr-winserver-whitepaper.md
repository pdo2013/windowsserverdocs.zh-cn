...
您能否满足这一要求并实施适当的技术安全措施, 必须反映在当今日益恶意的 IT 环境中面临的威胁。 如今的安全威胁环境是具有攻击性且顽固的威胁之一。 过去几年，恶意攻击者主要专注于通过其攻击获得社群认同，或因暂时使系统离线而获得的兴奋感。 从那时起，攻击者的动机已经转向获取金钱，包括将设备和数据作为抵押，直到所有者支付要求的赎金。
