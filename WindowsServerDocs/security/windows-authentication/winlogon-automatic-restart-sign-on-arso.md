...
![显示在锁屏界面的屏幕截图](../media/winlogon-automatic-restart-sign-on-arso/GTR_ADDS_LockScreenApp.gif)  
  
![显示锁屏界面应用的屏幕截图](../media/winlogon-automatic-restart-sign-on-arso/GTR_ADDS_LockScreen.gif)  
...
![显示策略设置的屏幕截图控制你可以指定是否设备将自动登录最后一个交互式用户后，Windows 更新会重新启动系统 UI](../media/winlogon-automatic-restart-sign-on-arso/GTR_ADDS_SignInPolicy.gif)  
