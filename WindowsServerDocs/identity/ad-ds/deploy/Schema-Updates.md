...
ms.locfileid: "71369615"
---
# <a name="windows-server-active-directory-schema-updates"></a>Windows Server Active Directory 架构更新

>适用于：Windows Server

本主题列出了包含 Adprep.log 所做更改的 .LDF 文件。  

这是 Windows Server 2019 中包含的 LDF 文件：

-   [Sch88](#BKMK_Sch88)

这些是 Windows Server 2016 中包含的 .LDF 文件：
...
这些是 Windows Server 2012 R2 中包含的 .LDF 文件：  
...
这些是 Windows Server 2012 中包含的 .LDF 文件：  
