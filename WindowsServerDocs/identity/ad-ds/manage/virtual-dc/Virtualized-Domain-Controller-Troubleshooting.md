...
|        **源**        |                                                                                                                         Microsoft-Windows-ActiveDirectory_DomainService                                                                                                                          |
|       **Severity**       |                                                                                                                                              错误                                                                                                                                               |
|       **Message**        | *<COMPUTERNAME>* 无法为克隆的 DC 创建域控制器帐户。<br /><br />原始 DC 名称：%1<br /><br />克隆的 DC 的允许数量：%2<br /><br />可以生成的克隆域控制器帐户的数量上限<em> <COMPUTERNAME></em>超出了。 |
...
|        Source        |                                                                                                                                                                                                                                                                                   Microsoft-Windows-DirectoryServices-DSROLE-Server                                                                                                                                                                                                                                                                                    |
|       Severity       |                                                                                                                                                                                                                                                                                                         错误                                                                                                                                                                                                                                                                                                          |
|       Message        | 虚拟域控制器克隆无法重置克隆计算机的 IP 地址。<br /><br />返回的错误代码为 %1 (%2)。<br /><br />虚拟域控制器配置文件中网络配置部分的配置问题可能会导致此错误。<br /><br />有关与虚拟域控制器克隆尝试期间 IP 地址重置相对应的错误的详细信息，请参阅 %systemroot%\debug\dcpromo.log。<br /><br />重置克隆的计算机上的计算机 IP 地址的详细信息，请参阅 https://go.microsoft.com/fwlink/?LinkId=208030 |
...
|              |            | Dfsr (532) \\ \\.\C:\System Volume Information\DFSR\database<em> _<GUID></em>\dfsr.db:数据库引擎创建新的数据库 (1， \\ \\.\C:\System Volume Information\DFSR\database<em>_ <GUID></em>\dfsr.db)。 （时间 = 0 秒）<br /><br />内部计时序列：[1] 0.000、[2] 0.000、[3] 0.016、[4] 0.062、[5] 0.000、[6] 0.016、[7] 0.000、[8] 0.000、[9] 0.015、[10] 0.000、[11] 0.000。 |
