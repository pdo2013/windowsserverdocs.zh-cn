...
#### [方案：中央访问策略](solution-guides/Scenario--Central-Access-Policy.md)
##### [部署中央访问策略（示范步骤）](solution-guides/Deploy-a-Central-Access-Policy--Demonstration-Steps-.md)
...
#### [方案：拒绝访问协助](solution-guides/Scenario--Access-Denied-Assistance.md)
...
### [Active Directory 域服务的新增功能](whats-new-active-directory-domain-services.md)
...
##### [介绍 Active Directory 域服务 (AD DS) 虚拟化（级别 100）](ad-ds/Introduction-to-active-directory-Domain-Services-AD-DS-Virtualization-Level-100.md)
...
###### [Azure 虚拟机上运行 Active Directory](ad-ds/deploy/virtual-dc/adds-on-azure-vm.md)
...
##### [在 Windows Server 2000 组织中部署 AD DS](ad-ds/plan/Deploying-AD-DS-in-a-Windows-2000-Organization.md)
...
####### [自主性与隔离性](ad-ds/plan/Autonomy-vs.-Isolation.md)
...
###### [选择林根域](ad-ds/plan/selecting-the-forest-Root-Domain.md)
...
##### [为逻辑结构设计查找其他资源](ad-ds/plan/finding-additional-Resources-for-Logical-Structure-Design.md)
...
##### [为启用高级功能查找其他资源](ad-ds/plan/finding-additional-Resources-for-Enabling-Advanced-Features.md)
...
#### [Active Directory 域服务安装和删除的新增功能](ad-ds/deploy/What-s-New-in-active-directory-Domain-Services-Installation-and-removal.md)
...
##### [附录 D：保护 Active Directory 中的内置 Administrator 帐户的安全](ad-ds/plan/security-best-practices/appendix-D--Securing-Built-In-Administrator-Accounts-in-active-directory.md)
...
##### [附录 L：事件监视器](ad-ds/plan/appendix-L--Events-to-Monitor.md)
...
#### [Active Directory 联合身份验证服务的新增功能](ad-fs/overview/whats-new-active-directory-federation-services-windows-server.md)
...
#### [部署 Azure AD Connect Health 监视你在云中的本地标识基础结构](https://azure.microsoft.com/documentation/articles/active-directory-aadconnect-health)


#### [Windows Server 2016 和 2012 R2 AD FS 部署指南](ad-fs/deployment/Windows-Server-2012-R2-AD-FS-Deployment-Guide.md)
##### [部署联合服务器场](ad-fs/deployment/Deploying-a-Federation-Server-Farm.md)
###### [将计算机加入到域](ad-fs/deployment/Join-a-computer-to-a-Domain.md)
...
##### [清单：实施联合的 Web SSO 设计](ad-fs/deployment/Checklist--Implementing-a-Federated-Web-SSO-Design.md)
...
###### [清单：配置资源合作伙伴组织](ad-fs/deployment/Checklist--Configuring-the-Resource-Partner-Organization.md)
...
###### [配置客户端计算机为信任帐户联合服务器](ad-fs/deployment/Configure-Client-computers-to-Trust-the-Account-Federation-Server.md)
...
###### [为联合服务器将主机 (A) 资源记录添加到企业 DNS](ad-fs/deployment/add-a-Host--A--Resource-Record-to-Corporate-DNS-for-a-Federation-Server.md)
...
###### [清单：配置 AD FS 以使用 AD FS 1.x 声明](ad-fs/deployment/Checklist--Configuring-AD-FS--to-Consume-Claims-from-AD-FS-1.x.md)
...
###### [清单：配置 AD FS 以将声明发送到 AD FS 1.x 声明感知的 Web 代理](ad-fs/deployment/Checklist--Configuring-AD-FS-to-Send-Claims-to-an-AD-FS-1.x-Claims-Aware-Web-Agent.md)
...
##### [准备迁移 AD FS 联合服务器](ad-fs/deployment/prepare-migrate-ad-fs-server-r2.md)
...
#### [在 AD FS 中自定义 ID 令牌](ad-fs/development/Custom-Id-Tokens-in-AD-FS.md)
...
#### [使用 AD FS 利用 OAuth 公共客户端生成本机客户端应用程序 ](ad-fs/development/native-client-with-ad-fs.md)
...
#### [添加属性存储](ad-fs/operations/add-an-attribute-Store.md)
#### [复合身份验证和 AD FS 中的 AD DS 声明](ad-fs/operations/AD-FS-Compound-Authentication-and-AD-DS-claims.md)
#### [配置 AD FS 执行用户证书身份验证](ad-fs/operations/Configure-User-Certificate-Authentication.md)
...
#### [配置 AD FS 对存储在 LDAP 目录中的用户进行身份验证](ad-fs/operations/Configure-AD-FS-to-authenticate-users-stored-in-LDAP-directories.md)
...
#### [配置基于设备的条件性访问本地](ad-fs/operations/Configure-Device-based-Conditional-Access-on-Premises.md)
...
#### [自定义 HTTP 安全响应标头与 AD FS](ad-fs/operations/customize-http-security-headers-ad-fs.md)
...
#### [操作实例：Windows 设备上的 Workplace Join](ad-fs/operations/Walkthrough--Workplace-Join-with-a-Windows-Device.md)
#### [操作实例：iOS 设备上的 Workplace Join](ad-fs/operations/Walkthrough--Workplace-Join-with-an-iOS-Device.md)
#### [操作实例：Android 设备上的 Workplace Join](ad-fs/operations/Walkthrough--Workplace-Join-to-an-Android-device.md)
...
#### [了解关键 AD FS 概念](ad-fs/technical-reference/Understanding-Key-AD-FS-Concepts.md)
