...
1. 将虚拟机连接到 ID_AD_Network。 登录到 DC1 以管理员身份使用密码<strong>pass@word1</strong>。  
...
12. 上**域控制器选项**页上，选择域和林功能级别为 Windows Server 2012，指定 DSRM 密码<strong>pass@word1</strong>，然后单击**下一步**.  
...
3. 将虚拟机加入到 contoso.com 域，并以 contoso\administrator 身份使用密码然后登录到 FILE1 <strong>pass@word1</strong>。  
...
1. 以 contoso\administrator 的身份使用密码登录到 FILE1: <strong>pass@word1</strong>。  
...
19. 上**服务帐户**屏幕上，在**域用户帐户**，单击**指定**，然后指定用户名 (**contoso\rms**)，并密码 (<strong>pass@word1</strong>)，单击**确定**，然后单击**下一步**。  

20. 在“加密模式”  屏幕上，单击“加密模式 2”  。  

21. 在“群集密钥存储”  屏幕上，单击“下一步”  。  

22. 上**群集密钥密码**屏幕上，在**密码**并**确认密码**框中，键入<strong>pass@word1</strong>，然后单击**下一步**。  
...
28. 在“结果”  屏幕上，单击“关闭”  ，然后在“安装进度”  屏幕上，单击“关闭”  。 完成后，先注销，然后以 contoso\rms 的身份使用提供的密码登录 (<strong>pass@word1</strong>)。  
...
31. 在用户和权限部分中，单击**用户和权限**，单击**添加**，类型<strong>financeadmin@contoso.com</strong>，然后单击**确定**。  
...
1. 以 contoso\administrator 的身份使用密码登录： <strong>pass@word1</strong>。  
...
1. 将虚拟机连接到 ID_AD_Network。 登录到 DC2 以管理员身份使用密码<strong>Pass@word1</strong>。  
...
创建名为 Jeff Low 的用户的密码<strong>pass@word1</strong>，并分配值的公司属性**Adatum**。  
...
1. 在 Hyper-V 管理器中，连接到服务器 FILE1。 通过使用 Contoso\Administrator 和密码登录到服务器<strong>pass@word1</strong>。  
