...
1. 登录到域控制器，以管理员身份使用密码的 adatum.com <strong>pass@word1</strong>。  
...
1. 登录到域控制器，以管理员身份使用密码的 contoso.com <strong>pass@word1</strong>。  
...
1. 登录到客户端计算机，作为密码使用名为 Jeff Low 的 CLIENT1 <strong>pass@word1</strong>。  
