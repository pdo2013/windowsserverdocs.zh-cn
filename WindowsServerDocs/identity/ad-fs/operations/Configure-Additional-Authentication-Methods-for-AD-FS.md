...
你是否知道 Microsoft Azure 在云中提供类似的功能？ 了解有关 [Microsoft Azure 标识解决方案](http://aka.ms/m2w274)的详细信息。<br /><br />在 Microsoft Azure 中创建混合标识解决方案：<br /> - [了解 Azure 多重身份验证。](http://aka.ms/ey6o9r)<br /> - [使用云身份验证管理单个林混合环境的标识。](http://aka.ms/g1jat8)<br /> - [管理敏感应用程序的附加多重身份验证的风险。](http://aka.ms/kt1bbm)
...
|SafeNet, Inc.|适用于 AD FS 的 SafeNet 身份验证服务 (SAS) 代理|@no__t 0SafeNet 身份验证服务：AD FS 代理配置指南 @ no__t-0|
