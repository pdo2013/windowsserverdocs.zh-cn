...
- 出现如外围网络林包含合作伙伴标识的单向林信任时，我们建议部署 ADFS，在 corp 林和外围网络林视为通过 LDAP 连接的另一个本地声明提供方信任。 事件不能采用此选项，您需要在"信任"林"受信任林"，在"信任"的林具有完全访问权限的用户在使用服务帐户中运行 ADFS。
