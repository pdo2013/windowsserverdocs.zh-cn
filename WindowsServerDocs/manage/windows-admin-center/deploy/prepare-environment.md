...
ms.locfileid: "4339585"
---
# 为 Windows Admin Center 准备环境
...
## 准备 Windows Server 2012 和 2012 R2
...
确保[.NET Framework 4.5.2 或更高版本](https://docs.microsoft.com/dotnet/framework/install/on-windows-7)已安装在计算机上。
...
## 准备 Microsoft Hyper-V Server 2016

要使用 Windows Admin Center 管理 Microsoft Hyper-V Server 2016，你将需要在执行此操作之前启用一些服务器角色。

### 要使用 Windows Admin Center 管理 Microsoft Hyper-V Server 2016，请执行以下操作：
...
### **步骤 3：** 启用 PowerShell 的 Hyper-V 模块
...
### **步骤 1：** 安装 Windows Management Framework 5.1
...
### 步骤 4：启用 PowerShell 的 Hyper-V 模块 ##
