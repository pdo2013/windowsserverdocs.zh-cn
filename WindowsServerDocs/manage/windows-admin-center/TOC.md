...
## 用途
### [立即开始](use/get-started.md)
### [管理服务器](use/manage-servers.md)
### [管理超级集成基础架构](use/manage-hyper-converged.md)
...
#### [目标 SDK 版本](extend/target-sdk-version.md)
### [指南](extend/guides.md)
#### [将模块添加到工具扩展中](extend/guides/add-module.md)
#### [将 iFrame 添加到工具扩展中](extend/guides/add-iFrame.md)
#### [在工具扩展中使用自定义的网关插件](extend/guides/use-custom-gateway-plugin.md)
...
#### [UI 文本消息和设计风格指南](extend/guides/ui-text-style-guide.md)
#### [在扩展中使用 PowerShell](extend/guides/powershell.md)
#### [CSS 图标指南](extend/guides/cssicons.md)
#### [迁移到最新的 SDK](extend/guides/migration-guide-0_1-1_0.md)
