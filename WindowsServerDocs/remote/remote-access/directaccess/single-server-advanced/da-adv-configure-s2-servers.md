...
|[规划高级的 DirectAccess 部署](Plan-an-Advanced-DirectAccess-Deployment.md)|使用包含 DirectAccess 客户端的安全组配置远程访问服务器。|  
...
5.  在“身份验证”页上：  
    ...
    -   若要启用 Windows 7 客户端计算机通过 DirectAccess 进行连接，请选择**使 Windows 7 客户端计算机能够通过 DirectAccess 进行连接**复选框。  
