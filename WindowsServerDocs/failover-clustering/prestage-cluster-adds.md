...
>[!NOTE]
>没有用于创建与 Active Directory 分离的群集，其中在 AD DS 中创建任何 CNO 或 Vco 的选项。 此选项适用于特定类型的群集部署。 有关详细信息，请参阅[部署与 Active Directory 分离的群集](<https://docs.microsoft.com/previous-versions/windows/it-pro/windows-server-2012-r2-and-2012/dn265970(v%3dws.11)>)。
...
- 选项 2：[预安排群集角色 VCO](#prestage-a-vco-for-a-clustered-role)。 如果由于组织的要求，必须为群集角色预安排帐户，请使用此选项。 例如，你可能需要控制命名约定，或者控制创建哪些群集角色。
