...
Windows Server 虚拟化技术包括 HYPER-V、 HYPER-V 虚拟交换机以及受保护构造和受防护的虚拟机 \(VMs\) 到的更新，能够提升安全性、 可扩展性和可靠性。 与 Hyper-V 配合使用时，对故障转移群集、网络和存储的更新甚至会使这些技术的部署和管理更加轻松。 
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>此外，Hyper-V 虚拟交换机提供了针对安全、隔离和服务级别的策略执行。</p>
                    </div>
                </div>
            </div>
        </div>
