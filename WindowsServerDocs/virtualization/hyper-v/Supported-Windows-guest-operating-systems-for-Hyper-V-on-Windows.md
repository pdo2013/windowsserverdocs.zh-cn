...
|Windows Server 2012 R2 和 Windows 8.1|[在 Windows Server 2012 R2 和 Windows 8.1 中，@no__t 0 支持 hyper-v 的 Windows 来宾操作系统](https://docs.microsoft.com/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/dn792027(v=ws.11))<br />@no__t[hyper-v 上的 Linux 和 FreeBSD 虚拟机](Supported-Linux-and-FreeBSD-virtual-machines-for-Hyper-V-on-Windows.md)|  
