...
**测试故障转移**:如果你想要运行主虚拟机的测试故障转移右键单击并选择**复制** > **测试故障转移**。 如果配置，请选择最新或其他恢复点。 将创建并在辅助站点上启动新的测试虚拟机。 测试完成后，选择**停止测试故障转移**清理它在副本虚拟机上。 请注意，您可以只运行一个虚拟机的测试故障转移一次。 [阅读更多](https://blogs.technet.com/b/virtualization/archive/2012/07/26/types-of-failover-operations-in-hyper-v-replica.aspx)。  
