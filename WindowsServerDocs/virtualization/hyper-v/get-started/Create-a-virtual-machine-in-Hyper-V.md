...
## <a name="BKMK_HyperVManager"></a>使用 Hyper-v 管理器创建虚拟机  
...
4.  在每个页上进行恰当的选择为虚拟机。 有关详细信息，请参阅[新的虚拟机选项和 Hyper-v 管理器中的默认值](#BKMK_Options)本主题中更高版本。  
...
## <a name="BKMK_PowerShell"></a>使用 Windows PowerShell 创建虚拟机  
...
## <a name="BKMK_Options"></a>在新虚拟机向导中的 HYPER-V 管理器选项  
...
- [支持的虚拟机配置版本](../deploy/Upgrade-virtual-machine-version-in-Hyper-V-on-Windows-or-Windows-Server.md#BKMK_SupportedConfigVersions)  
