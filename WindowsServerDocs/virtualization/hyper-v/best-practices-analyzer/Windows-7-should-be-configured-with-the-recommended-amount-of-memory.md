...
ms.locfileid: "59812288"
---
# <a name="windows-7-should-be-configured-with-the-recommended-amount-of-memory"></a>建议的内存量应该配置为 Windows 7
...
*建议为 1 GB 的 RAM 量低于配置运行 Windows 7 的虚拟机。*  
