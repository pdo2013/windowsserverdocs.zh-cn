...
ms.locfileid: "59871288"
---
# <a name="windows-81-should-be-configured-with-the-recommended-amount-of-memory"></a>Windows 8.1 应配置与建议的内存量
...
## <a name="issue"></a>**问题**  
*建议为 1 GB 的 RAM 量低于配置运行 Windows 8.1 的虚拟机。*  
