---
title: 应为 Windows Server 2008 R2 配置了至少最小内存量
...
ms.locfileid: "59818838"
---
# <a name="windows-server-2008-r2-should-be-configured-with-at-least-the-minimum-amount-of-memory"></a>应为 Windows Server 2008 R2 配置了至少最小内存量
...
*运行 Windows Server 2008 R2 的虚拟机的最小为 512 MB 的 RAM 量低于配置。*  
...
### <a name="to-increase-the-memory-using-hyper-v"></a>若要增加内存使用的 HYPER-V  
