---
title: 应为 Windows Server 2008 配置了至少最小内存量
...
ms.locfileid: "59830878"
---
# <a name="windows-server-2008-should-be-configured-with-at-least-the-minimum-amount-of-memory"></a>应为 Windows Server 2008 配置了至少最小内存量
...
*运行 Windows Server 2008 的虚拟机的最小为 512 MB 的 RAM 量低于配置。*  
