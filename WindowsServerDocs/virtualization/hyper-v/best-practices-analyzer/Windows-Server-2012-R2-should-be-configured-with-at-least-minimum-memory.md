---
title: 应为 Windows Server 2012 R2 配置了至少最小内存量
...
ms.locfileid: "59856218"
---
# <a name="windows-server-2012-r2-should-be-configured-with-at-least-the-minimum-amount-of-memory"></a>应为 Windows Server 2012 R2 配置了至少最小内存量
...
## <a name="issue"></a>**问题**  
*运行 Windows Server 2012 R2 的虚拟机的最小为 512 MB 的 RAM 量低于配置。*  
