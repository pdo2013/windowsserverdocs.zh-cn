---
title: Windows Server 2016 应为配置了至少最小内存量
...
ms.locfileid: "59873878"
---
# <a name="windows-server-2016-should-be-configured-with-at-least-the-minimum-amount-of-memory"></a>Windows Server 2016 应为配置了至少最小内存量
...
## <a name="issue"></a>**问题**  
*运行 Windows Server 2016 的虚拟机的最小为 512 MB 的 RAM 量低于配置。*  
