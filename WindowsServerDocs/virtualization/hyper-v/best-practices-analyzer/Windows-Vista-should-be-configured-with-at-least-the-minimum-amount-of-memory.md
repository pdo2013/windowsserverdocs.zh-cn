---
title: 应为 Windows Vista 配置了至少最小内存量
...
ms.locfileid: "59814998"
---
# <a name="windows-vista-should-be-configured-with-at-least-the-minimum-amount-of-memory"></a>应为 Windows Vista 配置了至少最小内存量
...
*运行 Windows Vista 的虚拟机的最小为 512 MB 的 RAM 量低于配置。*  
