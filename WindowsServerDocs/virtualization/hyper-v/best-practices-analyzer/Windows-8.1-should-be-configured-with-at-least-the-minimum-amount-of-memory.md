---
title: 应为 Windows 8.1 配置了至少最小内存量
...
ms.locfileid: "59822848"
---
# <a name="windows-81-should-be-configured-with-at-least-the-minimum-amount-of-memory"></a>应为 Windows 8.1 配置了至少最小内存量
...
## <a name="issue"></a>**问题**  
*运行 Windows 8.1 的虚拟机的最小为 512 MB 的 RAM 量低于配置。*  
