---
title: 运行 Windows 8 并配置了动态内存的虚拟机应使用的内存设置的建议的值
...
ms.locfileid: "59861028"
---
# <a name="a-virtual-machine-running-windows-8-and-configured-with-dynamic-memory-should-use-recommended-values-for-memory-settings"></a>运行 Windows 8 并配置了动态内存的虚拟机应使用的内存设置的建议的值
...
## <a name="issue"></a>**问题**  
*一个或多个虚拟机配置为使用动态内存低于建议的适用于 Windows 8 的内存量。*  
