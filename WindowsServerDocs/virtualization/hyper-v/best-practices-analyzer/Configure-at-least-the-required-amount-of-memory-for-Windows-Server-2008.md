---
title: 配置至少运行 Windows Server 2008 并启用了动态内存的虚拟机的内存所需的数量
...
ms.locfileid: "59876338"
---
# <a name="configure-at-least-the-required-amount-of-memory-for-a-virtual-machine-running-windows-server-2008-and-enabled-for-dynamic-memory"></a>配置至少运行 Windows Server 2008 并启用了动态内存的虚拟机的内存所需的数量
...
## <a name="issue"></a>问题  
*一个或多个虚拟机配置为使用 Windows Server 2008 所需的内存量小于使用动态内存。*  
