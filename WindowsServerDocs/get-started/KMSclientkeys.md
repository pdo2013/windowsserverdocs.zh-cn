...
## <a name="windows-10-all-supported-semi-annual-channel-versions"></a>Windows 10 中，所有支持的半年频道版本

请参阅[Windows 生命周期简报](https://support.microsoft.com/en-us/help/13853/windows-lifecycle-fact-sheet)有关受支持的版本和终止服务日期信息。
...
## <a name="earlier-versions-of-windows-server"></a>Windows Server 的早期版本
