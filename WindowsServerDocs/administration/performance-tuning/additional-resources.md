...
-   [电源策略配置和部署 Windows](https://msdn.microsoft.com/library/windows/hardware/mt422910.aspx)
...
-   [性能优化 NTttcp](https://msdn.microsoft.com/library/windows/hardware/dn567663(v=vs.85).aspx)
...
-   [销售和分发工作负荷的性能优化](https://msdn.microsoft.com/library/windows/hardware/dn567646(v=vs.85).aspx)
