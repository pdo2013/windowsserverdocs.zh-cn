---
title: Windows Server 2019 激活
description: 如何激活 Windows Server 2019
ms.custom: na
...
>- Windows Server 2012 上的 KMS 安装必须经过更新才支持运行 Windows 10 和 Windows Server 2016 或 Windows Server 2019，客户端或更高版本的客户端或服务器操作系统的激活。 有关详细信息，请参阅[2016 年 7 月更新汇总为 Windows Server 2012](https://support.microsoft.com/help/3172615/july-2016-update-rollup-for-windows-server-2012)。 
>- Windows 8.1 或 Windows Server 2012 R2 上的 KMS 安装必须经过更新才可支持运行 Windows 10 和 Windows Server 2016 或 Windows Server 2019，客户端或更高版本的客户端或服务器操作系统的激活。 有关详细信息，请参阅[2016 年 7 月更新汇总为 Windows 8.1 和 Windows Server 2012 R2](https://support.microsoft.com/help/3172614/july-2016-update-rollup-for-windows-8.1-and-windows-server-2012-r2)。  
>- Windows Server 2008 R2 无法更新为支持运行 Windows Server 2016、 Windows Server 2019 或更高版本操作系统的客户端的激活。 
...
>[!NOTE] 
>若要解决此特殊情况，请联系你的激活呼叫中心。 有关详细信息，请参阅 [Microsoft 批量许可](https://go.microsoft.com/fwlink/?LinkID=73076)。

在运行批量许可版本的 Windows 10、 Windows Server 2019、 Windows Server 2016、 Windows 8.1、 Windows Server 2012 R2、 Windows Server 2012、 Windows 7、 Windows Server 2008 R2 的计算机，默认情况下，无额外配置的 KMS 客户端需要。

如果要将计算机从 KMS 主机、MAK 或零售版 Windows 转换为 KMS 客户端，请安装适用的 KMS 客户端安装密钥。 有关详细信息，请参阅[KMS 客户端安装密钥](../get-started/KMSclientkeys.md)。 
