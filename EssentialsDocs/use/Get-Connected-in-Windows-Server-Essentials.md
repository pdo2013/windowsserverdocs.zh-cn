...
9. 计算机成功连接到服务器后，可以 （如果您的计算机正在运行 Windows 8、 Windows 8.1 或 Windows 10、 仪表板和连接器，如下所示使用开始菜单上显示连接器 TrayApp 和服务器仪表板的快捷方式TrayApp 将可以从计算机的开始屏幕上）：  
