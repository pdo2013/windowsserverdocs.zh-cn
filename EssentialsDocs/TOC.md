...
##### [更改媒体流设置](install/Change-Media-Streaming-Settings.md)
...
##### [自定义 Microsoft 联机备份服务任务的注册](install/Customize-Sign-Up-for-Microsoft-Online-Backup-Service-task.md)
...
### [在 Windows Server Essentials 目标服务器1 上启用文件夹重定向](migrate/Enable-folder-redirection-on-the-Windows-Server-Essentials-Destination-Server.md)
...
### [Windows Server Essentials 仪表板概述](manage/Overview-of-the-Dashboard-in-Windows-Server-Essentials.md)
...
### [使用 Windows Server Essentials 中的远程 Web 访问](use/Use-Remote-Web-Access-in-Windows-Server-Essentials.md)
### [使用 Windows Server Essentials 中的共享文件夹](use/Use-Shared-Folders-in-Windows-Server-Essentials.md)
...
### [Windows Server Essentials 中的远程 Web 访问连接疑难解答](support/Troubleshoot-Remote-Web-Access-connectivity-in-Windows-Server-Essentials.md)
