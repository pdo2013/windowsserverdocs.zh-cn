...
-   适用于 Windows Server Essentials:如果找不到 Windows Server Essentials 还原 CD，您可以创建可启动 U 盘。 有关详细信息，请参阅[创建可启动 USB 闪存驱动器以还原客户端计算机](Restore-a-full-system-from-an-existing-client-computer-backup.md#BKMK_CreateBootable)。  
