...
3. 在 **“联机备份”** 区域中，单击 **“将证书上载到 Azure 备份保管库”** 。  
    ...
    这将打开**恢复服务**Azure 管理门户中。 如果你不已登录到 Azure，你将需要使用你的 Microsoft 帐户登录。  
...
9. 将服务器注册 Azure 备份服务。 有关详细信息，请参阅[注册此服务器用于备份](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_5)。  
  
10. 配置服务器的联机备份。 有关详细信息，请参阅 [Configure online backup](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_2)。  
...
5.  在 Azure 管理门户页上，你将看到**恢复服务**的左窗格中。 这就是将在其中管理中存储联机备份从 Windows Server Essentials 的备份保管库。  
...
6. 在 Windows Server Essentials 中，上载证书以用于联机备份。 有关详细信息，请参阅[将证书上载到 Azure 备份保管库中](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_1)。  
  
7. Azure 备份保管库注册服务器。 有关详细信息，请参阅[注册此服务器用于备份](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_5)。  
  
8. 配置服务器的联机备份。 有关详细信息，请参阅 [Configure online backup](Manage-Online-Backup-in-Windows-Server-Essentials.md#BKMK_2)。  
